...
class Client:
    ...
    @wrap_connection_error
    async def get_property(self, remote_path: str, option: dict) -> Any:
    ...
    @wrap_connection_error
    async def set_property(self, remote_path: str, option: list) -> None:
    ...
    @wrap_connection_error
    async def set_property_batch(self, remote_path: str, option: list) -> None:
...
class Resource:
    ...
    async def get_property(self, option: dict[str, Any]) -> str | None:
        """Get metadata property of the resource."""
        return await self.client.get_property(
            remote_path=self.urn.path(), option=option
        )

    async def set_property(self, option: dict[str, Any], value: Any) -> None:
...
class WebDavXmlUtils:
    ...
    @staticmethod
    def create_get_property_request_content(option: dict) -> bytes:
    ...
    @staticmethod
    def create_set_property_batch_request_content(options: list[dict]) -> bytes:
